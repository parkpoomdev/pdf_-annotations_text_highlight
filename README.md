...
<img width="870" height="511" alt="image" src="https://github.com/user-attachments/assets/c509e832-6261-4169-a5ee-2867091d10fb" />
...
4. Select text in the PDF and click "Add Comment" to save it to the list.
...
- This tool uses CDN-hosted PDF.js and Tailwind CSS.
